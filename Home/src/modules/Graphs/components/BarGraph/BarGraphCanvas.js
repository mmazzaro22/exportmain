...
class BarGraphCanvas extends React.Component {
    render() {
        ...
        return (
            <ChartCanvas ratio={ratio}
                         ...
                         padding={1}
            >
                <Chart id={1} yExtents={d => [0, d[dataSetY]]}>
...
BarGraphCanvas = fitDimensions(BarGraphCanvas);
