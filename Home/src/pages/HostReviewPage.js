...
function Container(props) {
	...
	<img className="avatar-img rounded-circle" alt="" src="assets/images/avatar/01.jpg"
	>
	</img>
	...
	<a className="btn btn-sm btn-primary-soft mb-0 ms-auto flex-shrink-0" href="add-listing.html"
	>
			Add New Listing
	...
	<button className="btn btn-primary w-100 d-block d-xl-none mt-2" aria-controls="dashboardMenu" data-bs-target="#dashboardMenu" data-bs-toggle="offcanvas" type="button"
	>
			 Dashboard Menu
	...
	<div className="offcanvas-xl offcanvas-end mt-xl-3" id="dashboardMenu" tabindex="-1"
	>
	...
	<Link className="nav-link" target="_self" to="/host-dashboard" type="spa"
	>
			Dashboard
	...
	<Link className="nav-link" target="_self" to="/host-listings" type="spa"
	>
			Listings
	...
	<Link className="nav-link active" target="_self" to="/host-reviews" type="spa"
	>
			Reviews
	...
	<img className="avatar avatar-md rounded-circle float-start me-3" alt="avatar" src="assets/images/avatar/01.jpg"
	>
	</img>
	...
	<a data-gallery="gallery" data-glightbox="" href="assets/images/category/hotel/4by3/07.jpg"
	>
			
	<img className="rounded" alt="" src="assets/images/category/hotel/4by3/07.jpg"
	>
	</img>
	...
	<a data-gallery="gallery" data-glightbox="" href="assets/images/category/hotel/4by3/08.jpg"
	>
			
	<img className="rounded" alt="" src="assets/images/category/hotel/4by3/08.jpg"
	>
	</img>
	...
	<a className="btn btn-sm btn-primary-soft mb-0" aria-controls="collapseComment" aria-expanded="true" data-bs-toggle="collapse" href="#collapseComment" role="button"
	>
			Reply
	...
	<a className="text-primary-hover text-reset small mb-0" href="#"
	>
			Report
	...
	<img className="avatar avatar-md rounded-circle float-start me-3" alt="avatar" src="assets/images/avatar/07.jpg"
	>
	</img>
	...
	<a className="btn btn-sm btn-primary-soft mb-0"
	>
			Reply 
	...
	<img className="avatar avatar-md rounded-circle float-start me-3" alt="avatar" src="assets/images/avatar/06.jpg"
	>
	</img>
	...
	<img className="avatar avatar-md rounded-circle float-start me-3" alt="avatar" src="assets/images/avatar/10.jpg"
	>
	</img>
