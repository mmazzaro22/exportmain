...
function Container(props) {
	...
	<img className="df-p-3" alt="logo" id="itdr" src="https://dittofipublicfiles.s3.us-west-2.amazonaws.com/2187/3378-logo_horizontal.png" width="100"
	>
	</img>
	...
	<form autocomplete="off" id="ivjto" method="POST" novalidate=""
	>
			
	<div className="df-mb-3"
	>
			
	<div className="df-mb-2" id="irz7x"
	>
	...
	<input className="d-input" autofocus="true" name="email" required="true" type="email" value="" onChange={(e) => {
	...
	<div className="df-mb-2" id="iqifo"
	>
	...
	<button className="d-button df-bg-primary df-rounded" id="i9vra" type="button"
	>
			Reset Password
	</button>
