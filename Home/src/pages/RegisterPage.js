...
function Container(props) {
	...
	<div className="df-vh-100 df-d-flex df-justify-content-center df-bg-light df-overflow-auto"
	>
			
	<div className="d-col d-col-tiny-12 d-col-4 d-col-small-9 d-col-medium-6"
	>
			
	<div
	>
			
	<div className="df-text-center df-py-3"
	>
			
	<img className="df-p-3" alt="logo" src="https://dittofipublicfiles.s3.us-west-2.amazonaws.com/2187/3377-3d logo w: shadow.png" width="100"
	>
	</img>
	...
	<div className="df-bg-white df-border df-rounded df-shadow-lg"
	>
			
	<div className="df-p-5"
	>
			
	<h2 className="df-mb-4"
	>
			Register
	</h2>

			
	<form autocomplete="off" id="i0t05" method="POST" novalidate=""
	>
			
	<div className="df-mb-3"
	>
			
	<div className="df-mb-2" id="ivbr9"
	>
			
	<label className="df-mb-2 df-text-muted" for="email"
	>
			E-Mail Address
	</label>
	...
	<input className="d-input" autofocus="true" id="ihhod" name="signUpEPI.email" required="false" type="email" value="" onChange={(e) => {
			var value = e.target.value; dispatch({type: "change_input", payload:{name: e.target.name, value }});
		}} value={signUpEPI?.["email"] || ""}
	>
	</input>
	...
	<input className="d-input" autofocus="true" id="i5q2n" name="signUpEPI.firstName" required="false" type="text" value="" onChange={(e) => {
			var value = e.target.value; dispatch({type: "change_input", payload:{name: e.target.name, value }});
		}} value={signUpEPI?.["firstName"] || ""}
	>
	</input>
	...
	<input className="d-input" autofocus="true" id="iybp4" name="signUpEPI.lastName" required="false" type="text" value="" onChange={(e) => {
			var value = e.target.value; dispatch({type: "change_input", payload:{name: e.target.name, value }});
		}} value={signUpEPI?.["lastName"] || ""}
	>
	</input>
	...
	<div className="df-mb-2 df-d-flex df-justify-content-between df-align-items-center"
	>
			
	<label className="df-text-muted df-m-0" for="password"
	>
			Password
	</label>
	...
	<input className="d-input" id="isqti" name="signUpEPI.password" required="true" type="password" onChange={(e) => {
			var value = e.target.value; dispatch({type: "change_input", payload:{name: e.target.name, value }});
		}} value={signUpEPI?.["password"] || ""}
	>
	</input>
	...
	<div className="d-flex df-d-flex df-align-items-center df-justify-content-end"
	>
			
	<button className="d-button df-rounded df-bg-success" id="i01t4" type="button" onClick={(e) => {
			var value = e.target.value; runAction({name: "SIGNUP"});
		}}
	>
			Register
	</button>
	...
	<Link id="i6cfg" to="/login" type="spa"
	>
	...
	<div className="df-text-center df-mt-5 df-text-muted" id="ivr38f"
	>
			
  Copyright © 2017-2021 — Acre Access INC.
