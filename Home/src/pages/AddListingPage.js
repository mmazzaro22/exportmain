...
function Container(props) {
	...
	let  { search, pathname } = useLocation(); let { page_property_id, } = Object.fromEntries(new URLSearchParams(search));
	...
	<Component0CustomComponent id="iv88" emit={runAction} componentDidMount={(e) => {
	...
	<Component0CustomComponent className="col-12 mx-auto text-center" emit={runAction} componentDidMount={(e) => {
			var value = e.target.value; runAction({name: "GETME"});
		}}
	>
...
{ Array.isArray(row["avatar"]) && row["avatar"].map((row, index) => { return (
	...
	<div className="d-col d-col-medium-12 d-col-small-12 d-col-tiny-12 d-col-12" id="ir4dy"
	>
...
{ currentPartnerSite &&
	...
	<div className="d-row Columns_4" id="iy0dj" layout="6/6"
	>
			
	<div className="d-col d-col-6 d-col-medium-12 d-col-small-12 d-col-tiny-12 Column_11" id="ilapd"
	>
	...
	<div className="d-col d-col-6 d-col-medium-12 d-col-small-12 d-col-tiny-12 Column_10" id="i3bzi"
	>
	...
	<div className="d-col d-col-6 d-col-medium-12 d-col-small-12 d-col-tiny-12 Column_8" id="iyio8"
	>
	...
	<div className="d-col d-col-6 d-col-medium-12 d-col-small-12 d-col-tiny-12 Column_9" id="iwlfl"
	>
	...
	<div className="d-col d-col-6 d-col-medium-12 d-col-small-12 d-col-tiny-12 Column_7" id="ir32j"
	>
	...
	<input className="form-check-input" name="createListingEPI.order_type_id" type="radio" value={perHourValue} onChange={(e) => {
			var value = Number(e.target.value); dispatch({type: "change_input", payload:{name: e.target.name, value }});
		}} checked={(createListingEPI?.["order_type_id"] || "") === (perHourValue)}
	>
	</input>
	...
	<div className="d-col d-col-6 d-col-medium-12 d-col-small-12 d-col-tiny-12" id="igi73"
	>
	</div>
	...
	<div className="DivBlock_13" id="iy9q5r"
	>
	...
	<button className="d-button Button btn mb-0 btn-success" type="button" onClick={(e) => {
			var value = e.target.value; runAction({name: "CREATELISTING", payload: {createListingPartnerSiteId:currentPartnerSite["Id"],createListingPropertyID:page_property_id}});
		}}
	>
			Create listing
	</button>
...
{ Array.isArray(row["avatar"]) && row["avatar"].map((row, index) => { return (
	...
	<a className="btn btn-sm btn-danger mb-0" href="#" onClick={(e) => {
			var value = e.target.value; runAction({name: "DELETELISTING", payload: {deleteListingPropertyID:page_property_id,deleteListingID:row["id"]}});
		}}
	>
			Delete
	...
	<Link className="btn btn-sm mb-0 btn-success" target="_self" to="/listing_added" type="spa"
	>
			Finish 
	</Link>
