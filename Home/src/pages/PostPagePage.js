...
function Container(props) {
	...
	let  { search, pathname } = useLocation(); let { helpPostId, } = useParams();
	...
	<Component0CustomComponent className="card card-body justify-content-center text-center px-4 px-sm-5 pt-6 pt-md-8 pb-8" id="ieb2vj" emit={runAction} componentDidMount={(e) => {
			var value = e.target.value; runAction({name: "GETHELPPOST", payload: {postId:helpPostId}});
		}}
	>
...
<Fragment>
{ getHelpPostEPR &&
	<RichText className="d-richtext" id="i72jcp" readOnly="true" data={getHelpPostEPR["contents"]}
	>
	</RichText>}</Fragment>
