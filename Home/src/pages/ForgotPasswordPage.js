...
function Container(props) {
	...
	<form autocomplete="off" id="ixehm" method="POST" novalidate=""
	>
			
	<div className="df-mb-3"
	>
			
	<div className="df-mb-2" id="ixuwr"
	>
	...
	<input className="d-input" autofocus="true" id="ib5yx" name="requestPasswordResetEPI.email" required="true" type="email" value="" onChange={(e) => {
			var value = e.target.value; dispatch({type: "change_input", payload:{name: e.target.name, value }});
		}} value={requestPasswordResetEPI?.["email"] || ""}
	>
	</input>
	...
	<button className="d-button df-bg-primary df-rounded" id="iycto" type="button" onClick={(e) => {
	...
	<Link id="ix5bj" to="/register" type="spa"
	>
	...
	<div className="df-text-center df-mt-5 df-text-muted"
	>
			
  Copyright © 2017-2023 — Acre Access
