...
{ isLoggedIn &&
	...
	<Component0CustomComponent className="pt-4" emit={runAction} componentDidMount={(e) => {
			var value = e.target.value; runAction({name: "GETBOOKINGS"});
		}}
	>
...
{ Array.isArray(getProfilePictureEPR) && getProfilePictureEPR.map((row, index) => { return (
	...
	<Link className="nav-link active" target="_self" to="/host-bookings" type="spa"
	>
			Bookings
	...
	<table className="d-table" id="iljuhbj"
	>
			
	<thead id="i8ppail"
	>
			
	<tr className="card-header" id="i0ftpzj"
	>
	</tr>
	...
	<div className="d-row" id="ifo4hwh" layout="6/6"
	>
	</div>
...
<Fragment>
{ Array.isArray(getBookingsEPR) && getBookingsEPR.map((row, index) => { return (
	<tr id="iims7ui"
	>
	...
	<td className="TableCell_1" id="iiketv1"
	>
			
	<span className="Span" id="ibm8a1m"
	>
	...
	<span className="Span_1" id="iev6o03"
	>
			{row["name"]}
	</span>
	...
	<span className="Span_2 fw-normal" id="it60zv2"
	>
			{row["booking_date"]}
	</span>
...
{ row["status"] &&
	...
	<span className="Span_3" id="iruxefg"
	>
			{row["status"]}
	</span>
	...
	<ToggleWrapper className="d-modal d--open-right d--closed" activetab="0" id="ieckyji" name="getBookingsEPR" type="text" onChange={(e) => {
			var value = e.target.value; dispatch({type: "change_input", payload:{name: e.target.name, value }});
		}} value={getBookingsEPR || ""}
	>
			
	<div className="d-modal-wrapper d--open-right d--open" id="iut40eq" role="d-toggle-wrapper d-with-portal" show="false"
	>
			
	<div className="d-modal-box" id="i0dli3"
	>
			
	<div className="d-modal-header" id="it2r1a2" onClick={(e) => {
			var value = e.target.value; runAction({name: "MODALSHOWBOOKING"});
		}}
	>
	...
	<Component0CustomComponent className="d-modal-body" id="i2cglhp" emit={runAction} componentDidMount={(e) => {
			var value = e.target.value; runAction({name: "GETONEBOOKING", payload: {bookingId:row["Id"]}});
		}}
	>
			
<Fragment>
{ Array.isArray(Data0) && Data0.map((row, index) => { return (
	<div id="io33bwe"
	>
			
	<form id="i1mmxqd" method="get"
	>
			
<Fragment>
{ Array.isArray(row["listing_id"]) && row["listing_id"].map((row, index) => { return (
	<div id="ira58g9"
	>
	...
	<div className="d-modal-footer" id="inpah5i"
	>
			
	<div className="d-row" id="i41uby2" layout="6/6"
	>
			
	<div className="d-col d-col-medium-12 d-col-small-12 d-col-tiny-12 d-col-6" id="ip1yabx"
	>
			
	<button className="d-button Button_2" id="iogi843" onClick={(e) => {
	...
	<div className="d-col d-col-medium-12 d-col-small-12 d-col-tiny-12 d-col-6" id="is4915s"
	>
			
	<button className="d-button Button_1" id="i75l6ev"
	>
			Reject
	</button>
	...
	<ToggleWrapper className="d-modal d--open-right d--closed" activetab="0" id="iqry67"
	>
			
	<button className="d-button Button_5" id="itqvhl" role="d-toggle-button"
	>
			View
	</button>

			
	<div className="d-modal-wrapper d--closed" id="i30ise" role="d-toggle-wrapper d-with-portal" show="false"
	>
			
	<div className="d-modal-box ModalBox_1" id="ip51fq"
	>
			
	<div className="d-modal-header" id="i5s1uz" onClick={(e) => {
			var value = e.target.value; runAction({name: "MODALSHOWBOOKING"});
		}}
	>
	...
	<div className="DivBlock_16" id="iyttk5" onClick={(e) => {
			var value = e.target.value; runAction({name: "MODALCLOSEBOOKING"});
		}}
	>
	...
	<div className="d-modal-body" id="inkfss"
	>
			
	<div id="iziohj"
	>
			
	<div className="d-row" id="ib6btd" layout="2/2/2/4/2"
	>
			
	<div className="d-col d-col-medium-12 d-col-small-12 d-col-tiny-12 d-col-6 Column_15" id="ioa9pr"
	>
	...
	<div className="d-col d-col-medium-12 d-col-small-12 d-col-tiny-12 d-col-12 Column_14" id="irzmbe"
	>
	...
	<img className="Image_12" id="ixvl9s" src="https://dittofipublicfiles.s3.us-west-2.amazonaws.com/2187/4656-03.jpg"
	>
	</img>
	...
	<div className="d-col d-col-medium-12 d-col-small-12 d-col-tiny-12 d-col-12 Column_13" id="i9nj2c"
	>
	...
	<div className="d-col d-col-medium-12 d-col-small-12 d-col-tiny-12 d-col-12 Column_12" id="idfmvk"
	>
	...
	<div className="d-modal-footer" id="ixevb7"
	>
			
	<button className="d-button btn btn-success bg-success" id="i56z4a" onClick={(e) => {
			var value = e.target.value; runAction({name: "APPROVEBOOKING", payload: {booking_id:row["id"],status:ApproveBookingRequest}});
		}}
	>
			Approve
	</button>
	...
	<button className="d-button btn btn-danger bg-danger" id="i0nahp" onClick={(e) => {
			var value = e.target.value; runAction({name: "REJECTBOOKINGREQUEST", payload: {booking_id:row["id"],rejectBookingId:row["id"],status:rejectBooking}});
		}}
	>
			Reject
	</button>
	...
	<div className="d-sm-flex justify-content-sm-between align-items-sm-center" id="ibqk2ao"
	>
			
	<p className="mb-sm-0 text-center text-sm-start" id="ikljv4x"
	>
			Showing 1 to 8 of 20 entries
	</p>

			
	<nav className="mb-sm-0 d-flex justify-content-center" aria-label="navigation" id="iwhucla"
	>
			
	<ul className="pagination pagination-sm pagination-primary-soft mb-0" id="iu6svxv"
	>
