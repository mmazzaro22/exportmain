...
{ Array.isArray(getProfilePictureEPR) && getProfilePictureEPR.map((row, index) => { return (
	...
	<Link className="nav-link active" target="_self" to="host-settings" type="spa"
	>
			Settings
	...
	<Component0CustomComponent className="pt-0" emit={runAction} componentDidMount={(e) => {
	...
	<input className="form-control d-none" id="uploadfile-1" type="file"
	>
	</input>
...
{ Array.isArray(getProfilePictureEPR) && getProfilePictureEPR.map((row, index) => { return (
	...
	<label className="d-file-upload d-button btn btn-success" id="i8jfyxh" onChange={(e) => {
			var value = e.target.value; runAction({name: "UPDATEIMAGEFILE", payload: {updateFilePath:currentUser["first_name"],updateFilePropertyId:(0),updateFileUserId:currentUser["Id"],file:uploadFile,filePath:currentUser["first_name"],fileUpdateFile:uploadFile,photosProperty_id:(0),photosUserId:currentUser["Id"]}});
		}}
	>
	...
	<input className="d-file-upload-input" id="iwp6z9" name="uploadFile" type="file" onChange={(e) => {
...
{ Loading &&
	...
	<div d-partial-id="1270" id="iolnmdn"
	>
	...
	<p className="Paragraph_6" id="ia4w0d"
	>
			{currentUser["phone number"]}
	</p>

			
	<input className="form-control" name="FormUpdateUsersEndpoint.phone number" placeholder="Enter your mobile number" type="text" value="222 555 666" onChange={(e) => {
			var value = e.target.value; dispatch({type: "change_input", payload:{name: e.target.name, value }});
		}} value={FormUpdateUsersEndpoint?.["phone number"] || ""}
	>
	</input>
	...
	<p className="Paragraph_6" id="it92qe"
	>
			{currentUser["bio"]}
	</p>

			
	<input className="form-control" name="FormUpdateUsersEndpoint.bio" placeholder="Update bio" type="plain" onChange={(e) => {
			var value = e.target.value; dispatch({type: "change_input", payload:{name: e.target.name, value }});
		}} value={FormUpdateUsersEndpoint?.["bio"] || ""}
	>
	</input>
	...
	<a className="btn btn-success" type="pagesection" onClick={(e) => {
			var value = e.target.value; runAction({name: "UPDATEUSER"}); 
	...
	<input className="form-control" name="updateUserEmail" placeholder="Enter your email id" type="email" onChange={(e) => {
			var value = e.target.value; dispatch({type: "change_input", payload:{name: e.target.name, value }});
	...
	<a className="btn btn-primary mb-0" type="pagesection" onClick={(e) => {
			var value = e.target.value; runAction({name: "UPDATEUSEREMAIL", payload: {updateEmail:updateUserEmail}}); 
						var element = document.getElementById("");
						if(element) {
							element.scrollIntoView({ block: 'end',  behavior: 'smooth' });
						}
	...
	<input className="form-control" placeholder="Enter current password" type="password"
	>
	</input>
	...
	<input className="form-control fakepassword" id="psw-input" placeholder="Enter new password" type="password"
	>
	</input>
	...
	<a className="btn mb-0 btn-success" type="pagesection" onClick={(e) => {
	...
	<label className="form-label"
	>
			Connect your account to our payment partner Stripe to be paid out your rental income: 
	</label>
	...
	<p className="mb-0"
	>
			Figure what you want to be notified about, and unsubscribe from what you don't.
	</p>
	...
	<input className="form-check-input" checked="true" id="flexRadioDaily" name="flexRadioDefault" type="radio" onChange={(e) => {
			var value = e.target.value; dispatch({type: "change_input", payload:{name: e.target.name, value }});
		}}
	>
	</input>
	...
	<input className="form-check-input" id="flexRadioDefault2" name="flexRadioDefault" type="radio" onChange={(e) => {
			var value = e.target.value; dispatch({type: "change_input", payload:{name: e.target.name, value }});
		}}
	>
	</input>
	...
	<input className="form-check-input" id="flexRadioDefault3" name="flexRadioDefault" type="radio" onChange={(e) => {
			var value = e.target.value; dispatch({type: "change_input", payload:{name: e.target.name, value }});
		}}
	>
	</input>
	...
	<input className="form-check-input" id="flexRadioDefault4" name="flexRadioDefault" type="radio" onChange={(e) => {
			var value = e.target.value; dispatch({type: "change_input", payload:{name: e.target.name, value }});
		}}
	>
	</input>
	...
	<input className="form-check-input flex-shrink-0" checked="true" id="checkPrivacy1" type="checkbox"
	>
	</input>
	...
	<input className="form-check-input flex-shrink-0" checked="true" id="checkPrivacy2" type="checkbox"
	>
	</input>
	...
	<input className="form-check-input flex-shrink-0" checked="true" id="checkPrivacy3" type="checkbox"
	>
	</input>
	...
	<input className="form-check-input flex-shrink-0" checked="true" id="checkPrivacy7" type="checkbox"
	>
	</input>
	...
	<input className="form-check-input flex-shrink-0" id="checkPrivacy4" type="checkbox"
	>
	</input>
	...
	<input className="form-check-input flex-shrink-0" id="checkPrivacy6" type="checkbox"
	>
	</input>
	...
	<input className="form-check-input flex-shrink-0" checked="true" id="checkPrivacy5" type="checkbox"
	>
	</input>
	...
	<button className="btn btn-sm btn-primary me-2 mb-0" type="button"
	>
			Save changes
	</button>

			
	<a className="btn btn-sm btn-outline-secondary mb-0" href="#"
	>
			Cancel
	</a>
	...
	<input className="form-control mb-2" placeholder="Enter your mobile number" type="text"
	>
	</input>
	...
	<button className="btn btn-sm btn-danger mb-0" type="button"
	>
			Invoke
	</button>

			
	<a className="btn btn-sm btn-link text-body mb-0" href="#"
	>
			Learn more
	</a>
	...
	<button className="btn btn-sm btn-primary mb-0" type="button"
	>
			Connect Linkedin
	</button>
	...
	<input className="form-control" placeholder="Enter username" type="text" value="loristev"
	>
	</input>
	...
	<input className="form-control" placeholder="Enter username" type="text" value="https://www.youtube.com/in/Booking-05620abc"
	>
	</input>
	...
	<footer className="bg-dark p-3" d-partial-id="1248"
	>
